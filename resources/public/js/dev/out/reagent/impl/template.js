...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27031__auto__,writer__27032__auto__,opt__27033__auto__){
return cljs.core._write.call(null,writer__27032__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28448 = o;
(G__28448[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__28449__delegate = function (args){
...
while (G__28450__i < G__28450__a.length) {G__28450__a[G__28450__i] = arguments[G__28450__i + 0]; ++G__28450__i;}
  args = new cljs.core.IndexedSeq(G__28450__a,0);
} 
...
var args = cljs.core.seq(arglist__28451);
...
if(cljs.core.truth_((function (){var and__26413__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__26413__auto__){
var and__26413__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__28457 = jsprops;
(G__28457["defaultValue"] = value);

(G__28457["onChange"] = ((function (G__28457,v,value,on_change){
return (function (p1__28454_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28454_SHARP_);
});})(G__28457,v,value,on_change))
);

(G__28457["ref"] = ((function (G__28457,v,value,on_change){
return (function (p1__28455_SHARP_){
return (this$["cljsInputElement"] = p1__28455_SHARP_);
});})(G__28457,v,value,on_change))
);
...
var vec__28464 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28464,(0),null);
var id = cljs.core.nth.call(null,vec__28464,(1),null);
var class$ = cljs.core.nth.call(null,vec__28464,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___28469 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___28469 == null)){
} else {
var key_28470 = temp__4661__auto___28469;
(jsprops["key"] = key_28470);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__28472 = (new reagent.impl.template.NativeWrapper());
(G__28472["name"] = c);
...
var len__27500__auto___28478 = arguments.length;
var i__27501__auto___28479 = (0);
while(true){
if((i__27501__auto___28479 < len__27500__auto___28478)){
args__27507__auto__.push((arguments[i__27501__auto___28479]));

var G__28480 = (i__27501__auto___28479 + (1));
i__27501__auto___28479 = G__28480;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27508__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28476){
var G__28477 = cljs.core.first.call(null,seq28476);
var seq28476__$1 = cljs.core.next.call(null,seq28476);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28477,seq28476__$1);
});
...
break;
default:
var G__28484 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__28484;
continue;
...
var n__27340__auto___28487 = a.length;
var i_28488 = (0);
while(true){
if((i_28488 < n__27340__auto___28487)){
(a[i_28488] = reagent.impl.template.as_element.call(null,(a[i_28488])));

var G__28489 = (i_28488 + (1));
i_28488 = G__28489;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__27340__auto___28490 = a.length;
var i_28491 = (0);
while(true){
if((i_28491 < n__27340__auto___28490)){
var val_28492 = (a[i_28491]);
if((cljs.core.vector_QMARK_.call(null,val_28492)) && ((reagent.impl.template.key_from_vec.call(null,val_28492) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28491] = reagent.impl.template.as_element.call(null,val_28492));
...
var ctx = ({});
var vec__28497 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28497,(0),null);
var derefed = cljs.core.nth.call(null,vec__28497,(1),null);
...
var G__28501 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28501) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__28501){
...
//# sourceMappingURL=template.js.map?rel=1480772919782