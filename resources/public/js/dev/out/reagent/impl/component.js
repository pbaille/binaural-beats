...
if((i < len)){
var k = (ks[i]);
var G__28381 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__28382 = (i + (1));
m = G__28381;
i = G__28382;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__28386 = c;
var G__28386__$1 = (((G__28386 == null))?null:G__28386.prototype);
if((G__28386__$1 == null)){
return null;
} else {
return (G__28386__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__28390 = c;
var G__28390__$1 = (((G__28390 == null))?null:G__28390.prototype);
if((G__28390__$1 == null)){
return null;
} else {
return (G__28390__$1["render"]);
}
})()));
});
...
return (function() { 
var G__28394__delegate = function (args){
...
while (G__28395__i < G__28395__a.length) {G__28395__a[G__28395__i] = arguments[G__28395__i + 0]; ++G__28395__i;}
  args = new cljs.core.IndexedSeq(G__28395__a,0);
} 
return G__28394__delegate.call(this,args);};
G__28394.cljs$lang$maxFixedArity = 0;
G__28394.cljs$lang$applyTo = (function (arglist__28396){
var args = cljs.core.seq(arglist__28396);
return G__28394__delegate(args);
});
...
var _STAR_current_component_STAR_28399 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_28399;
}});
...
var G__28403 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__28403) {
...
var or__26425__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__28405_28407 = (c["cljsRatom"]);
if((G__28405_28407 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__28405_28407);
}
...
if(cljs.core.truth_((function (){var and__26413__auto__ = wrap;
...
var render_fun_28411 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_28410));
if((cljs.core.count.call(null,renders_28410) > (0))){
} else {
...
if(((1) === cljs.core.count.call(null,renders_28410))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_28411)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_28411))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__26425__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__26425__auto__)){
return or__26425__auto__;
} else {
...
var render_fun__$1 = (function (){var or__26425__auto__ = render_fun;
if(cljs.core.truth_(or__26425__auto__)){
return or__26425__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__26425__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__26425__auto__)){
return or__26425__auto__;
} else {
...
var name__$1 = (function (){var G__28409 = name;
switch (G__28409) {
case "":
...
var G__28414 = o;
(G__28414[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__28420 = (function (){var or__26425__auto__ = (function (){var G__28422 = c;
if((G__28422 == null)){
return null;
} else {
return (G__28422["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__26425__auto__)){
return or__26425__auto__;
...
return (G__28420["_currentElement"]);
}
})();
var name = (function (){var G__28423 = elem;
var G__28423__$1 = (((G__28423 == null))?null:(G__28423["type"]));
if((G__28423__$1 == null)){
return null;
} else {
return (G__28423__$1["displayName"]);
}
})();
var path = (function (){var G__28424 = elem;
var G__28424__$1 = (((G__28424 == null))?null:(G__28424["_owner"]));
var G__28424__$2 = (((G__28424__$1 == null))?null:reagent$impl$component$component_path.call(null,G__28424__$1));
if((G__28424__$2 == null)){
return null;
} else {
return [cljs.core.str(G__28424__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__26425__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__26425__auto__)){
return or__26425__auto__;
} else {
var G__28426 = c;
var G__28426__$1 = (((G__28426 == null))?null:G__28426.constructor);
if((G__28426__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__28426__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1480772919314